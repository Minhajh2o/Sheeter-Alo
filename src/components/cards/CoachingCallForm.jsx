...
const CoachingCallForm = ({ onSubmitSuccess }) => {
  ...
  className="space-y-10 rounded-3xl border border-white/10 bg-slate-950/70 p-6 text-slate-100 shadow-lg shadow-slate-900/20 sm:p-8"
>
  {/* Header */}
  <div className="space-y-3">
    ...
    <h3 className="text-2xl font-semibold text-white">
      Plan your winter drive with a coordinator
    </h3>
  ...
  <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
    <p className="text-xs text-slate-400">
      We respond within 12 hours for Dhaka-based drives, 24 hours nationwide.
    </p>
